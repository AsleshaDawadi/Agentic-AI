...
chat_prompt= ChatPromptTemplate.from_messages([
   SystemMessagePromptTemplate.from_template("""
    ...
    This blog should contain high seo optimized tile keyword and detailed technical explanation . At the name of each Blog add my name as Aslesha Dawadi at the last.
    """),
